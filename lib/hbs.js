...
class ExpressHbs {
   ...
   */
  async _cacheLayout(layoutFile, useCache, viewsDir, allowedRoot = this.restrictLayoutsTo) {
   ...
   * @param {string} filename
   * @param {string | string[]} viewsDir
   * @returns {Promise<{ type: 'template', source: string, template: Function, declaredLayoutFile: string | undefined }>}
   */
   ...
   *
   * @param {string} filename
   * @param {{ declaredLayoutFile?: string }} templateInfo
   * @param {AnyObject} options
   * @param {string | string[]} viewsDir
   * @returns {Promise<Function[] | null>}
   */
