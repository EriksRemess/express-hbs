...
export default class Visitor {
  ...
  accept(object) {
    ...
    const nodeType = Object.hasOwn(object, 'type')
      ? object.type
      : undefined;

    if (!this[nodeType]) {
      throw new Exception(`Unknown type: ${nodeType}`, object);
    }
    ...
    this.current = object;
    const result = this[nodeType](object);
  ...
  MustacheStatement(mustache) {
    visitSubExpression.call(this, mustache);
  }
  ...
  SubExpression(sexpr) {
    visitSubExpression.call(this, sexpr);
  }
