...
export function template(templateSpec, env) {
  ...
  function createDirectPartialInvocationOptions(partial, options, hooks, protoAccessControl) {
    const partialOptions = createNewLookupObject();

    partialOptions.name = options.name;
    partialOptions.helpers = options.helpers;
    partialOptions.partials = options.partials;
    partialOptions.decorators = options.decorators;
  ...
  function invokePartialWrapper(partial, context, options) {
    ...
    if (!options.hash && !options.fn && !options.indent && typeof partial === 'function') {
      const partialOptions = createDirectPartialInvocationOptions(
        partial,
        options,
        this.hooks,
